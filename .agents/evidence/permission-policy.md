...
| PER-3 | `per_3_file_change_preset_pins_definitions_and_covers_the_pinned_root`, `per_3_inspection_preset_pins_only_read_and_search_definitions`, `per_3_confined_command_preset_pins_the_command_definition`; existing native admission/executor tests remain APV-3 evidence |
