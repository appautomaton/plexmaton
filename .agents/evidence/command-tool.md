...
| CMD-7 | `cmd_7_writes_outside_the_granted_roots_are_denied_by_the_os`, `every_root_reaching_a_profile_is_its_own_resolved_form`, `absent_roots_are_dropped_rather_than_granted`, `roots_are_deduplicated`, `profile_grants_follow_the_global_deny`, `profile_without_roots_denies_every_write`, `enforced_wraps_the_shell_and_terminates_its_own_arguments`, `unconfined_launches_the_shell_unchanged`, `a_binding_carries_the_whole_path_after_one_equals` |
