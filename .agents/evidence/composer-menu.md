...
| CMC-1 | `the_slash_lists_the_commands_and_only_a_whole_command_runs`, `a_requested_compaction_shows_on_the_activity_line_and_leaves_the_saying_to_its_row`; the runtime's CPL-9 proofs. A loopback run of `/compact` through the executable is unproven |
