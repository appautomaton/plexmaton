...
use plexmaton_agent::{
    ...
    JournalRecord, ModelRequest, ProviderReplay, RequestEnvironment, SessionEntry, SessionJournal,
...
fn session_id() -> SessionId {
    SessionId::new("codec-spike").expect("fixture id")
}
...
fn entry_id(value: &str) -> SessionEntryId {
    SessionEntryId::new(value).expect("fixture id")
}
