...
| Field | Value |
| --- | --- |
| Status | Active; stage 7 and stage 8 recovery slices 1–2 are complete; stage 8 slice 3 is next |
| Parent roadmap | [Roadmap](../roadmap.md) |
| Product contract | [UI/UX](../ui-ux.md) |
| Inherits | Phase 02 journal recovery, providers, compaction, permissions and conversation trees. APV-6 pending-request readmission remains unproven |
...
checkpointed locally through `a5cfdb2`; stage 8.1 is checkpointed through `c0133c8`, and stage 8.2
is complete in the current change. Earlier
...
| [8 — Recovery acceptance](../plans/phase-03-stage-08-recovery-acceptance.md) | Provisioning crash cuts; actual CLI kill→resume; pending approval readmission; final acceptance and closure | Active; slices 1–2 complete, slice 3 next |
