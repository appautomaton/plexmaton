...
1. Preserve the tested local resume fix and immutable historical fixtures. Rewrite the README
   with accurate product-led copy, relevant badges and maintained project links. Use current
   stable actions and the macOS Apple Silicon verification target.
...
No journal rewriting, live model requests, global workstation installation, release packaging,
unrelated repository changes, or claim of Linux compatibility. Public visibility is not blocked
by unrelated future product work.
