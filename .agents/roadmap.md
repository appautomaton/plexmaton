...
| 03 | Durable multi-agent mailbox and runtime ownership | Active; Stage 7 Slice 6 control UI built and the roster/Attention redesign reviewed and landed, production activation blocked |
