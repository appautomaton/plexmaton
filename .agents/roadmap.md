...
| 01 | One real agent in the workspace: a thin loop over one provider, and the transcript grammar against its output | Active; stage 2 slice 10 implemented; three-width user review remains |
