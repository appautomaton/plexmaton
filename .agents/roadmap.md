...
| 03 | Durable multi-agent mailbox and runtime ownership | Active; stage 7 and stage 8 provisioning recovery are complete; stage 8 CLI kill→resume is next. Current evidence and exit gates are in the phase file |
