...
| 02 | Canonical session state, persistence, durable permission policy, the remaining provider transports, context projection, and MCP | Active 2026-09-03; durable JSONL sessions, context atoms, model registry and request accounting complete; budget ledger next |
