...
| 03 | Durable multi-agent mailbox and runtime ownership | Active; stage 7 and stage 8 recovery slices 1–3 are complete; final acceptance is next. Process-dead approvals cannot continue, and new explicit work uses current policy. Current evidence and exit gates are in the phase file |
