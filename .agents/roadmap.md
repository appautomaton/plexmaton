...
| 02 | Canonical session state, persistence, durable permission policy, the remaining provider transports, context projection, and MCP | Active; public-readiness verification in progress; branch interaction and MCP remain |
