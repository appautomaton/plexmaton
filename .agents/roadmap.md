...
| 03 | Durable multi-agent mailbox and runtime ownership | Active; stage 7 product integration is complete and stage 8 recovery acceptance slice 1 is next. Current evidence and exit gates are in the phase file |
