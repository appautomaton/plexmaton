...
| 02 | Canonical session state, persistence, durable permission policy, the remaining provider transports, context projection, and MCP | Active 2026-09-03; durable JSONL sessions, chronology, schema epoch and context atoms complete; resolved model registry next |
