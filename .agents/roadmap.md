...
| 04 | Product polish, performance hardening, math in production, and extensibility | Active; stages 1–9, 11–15, 17–27, 29 and 31–33 complete; stage 16 effort selection awaits user testing; stage 28 model-switch degradation in progress; stage 30 automatic-compaction visibility unstarted; stage 34 conversation chrome in progress; stage 10 branding planned and unstarted |
...
| [Provider-side tools spike](./spikes/provider-side-tools/README.md) | Compare how harnesses surface a tool the provider runs, and measure one live hosted-search route | Live measurement retained; implemented as phase 04 stage 33, whose behaviour PRV-5, PRV-6 and ENT-2 own |
