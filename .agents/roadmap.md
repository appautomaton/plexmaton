...
| 01 | One real agent in the workspace: a thin loop over one provider, and the transcript grammar against its output | Active; stage 2 slices 1–7 landed; slice 8 next |
