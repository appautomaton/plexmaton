...
| 03 | Durable multi-agent mailbox and runtime ownership | Active; stage 7 and stage 8 recovery slices 1–2 are complete; pending approval readmission is next. Current evidence and exit gates are in the phase file |
