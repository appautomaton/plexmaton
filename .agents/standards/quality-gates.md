...
| `python3 scripts/smoke-delegate.py` | Delegation/mail/task update, Handoff/User input, Stop/root continuation, three-width resume, CLI process cuts, and process-dead approval followed by fresh current-policy work. Acceptance evidence |
