...
| INV-10 | `an_arrow_moves_the_rail_and_scrolls_everything_else`, `an_arrow_moves_the_roster_and_entering_an_asking_agent_goes_to_its_request`, `approval_keys_stay_inside_the_blocking_surface`, `narrow_agents_has_one_closed_navigation_grammar` |
