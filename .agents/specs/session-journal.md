...
numbered event stream without invoking providers, tools, policy or files. Model-facing tool results share execution's `MAX_TOOL_OUTCOME_BYTES` ceiling (1 MiB),
independent of ENT-4's transcript-preview limit. A complete assistant
