...
journal retain the same metadata. CPL-4 adds checkpoint and collected-attempt records within this
epoch; valid pre-compaction journals remain readable. A foreign epoch fails before record decoding. Rejected: rolling
