...
| JRN-2 | `jrn_2_invalid_records_change_nothing`, `jrn_2_the_same_records_build_equal_journals_and_paths`, `jrn_2_each_head_mutation_rejects_a_stale_revision`, `jrn_2_each_head_mutation_rejects_a_missing_head`, `jrn_2_an_unknown_append_parent_is_a_missing_entry`, `jrn_2_head_names_are_never_reused`, `tim_1_invalid_terminal_records_change_nothing`, `tim_1_partial_head_mutations_preserve_or_refuse_the_open_turn`, `tim_1_jsonl_rejects_untimed_turns_and_unscoped_lifecycle_records` |
| JRN-3 | `jrn_3_every_record_round_trips_and_debug_redacts_replay`, `jrn_3_every_context_block_variant_round_trips_inside_an_append`, `jrn_3_every_canonical_payload_variant_round_trips_inside_an_append`, `jrn_3_decoding_rechecks_identity_and_replay_bounds`, `assistant_output_round_trips_order_and_redacts_replay`, `assistant_output_rejects_duplicate_semantic_identities`, `jrn_3_and_jrn_4_encrypted_replay_round_trips_through_the_file`, `jrn_3_a_foreign_schema_epoch_is_refused_before_records`, `jrn_4_create_append_reopen_and_immediate_visibility`, `runtime_clock_values_reach_session_and_turn_chronology`, `a_default_session_is_durable_and_ephemeral_is_an_explicit_opt_out` |
