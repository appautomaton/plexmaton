...
MOT-1 owns the one visible-only motion deadline; its phase invalidates presentation without
advancing semantic revision (MOT-3). The same cell/native commit path publishes every frame.
