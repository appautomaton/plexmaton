...
| APV-6 | `interrupt_and_shutdown_cancel_pending_approval_as_explicit_state`, `cancellation_before_admission_has_outcome_without_invocation`, `abandoning_answers_everything_outstanding_and_leaves_settled_calls_alone`, `passive_attention_reopens_from_the_validated_prefix_without_waking`, `passive_orphan_attention_is_not_projected_or_activated`, `graceful_shutdown_resolution_does_not_reopen_a_child_request`; restored readmission under current policy remains unproven and belongs to Phase 03 stage 8.3 |
