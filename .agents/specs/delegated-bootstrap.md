...
| Field | Value |
| --- | --- |
| Status | Implemented, wired and accepted. The real child stays passive across graceful and process-kill resume, then reopens by pointer and keyboard at 120/95/60 columns |
