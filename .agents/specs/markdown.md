...
entries and 4 MiB of accounted allocation capacity, including text maps and composed style layers,
...
changes do not invalidate preparation. A delta replaces its old revision. An evicted layout is
...
admitted preparation completions, including typed refusals.
