...
| Field | Value |
| --- | --- |
| Status | Implemented through Phase 01 stage 2 slice 3; approval remains unproven |
...
a pending record; a typed command resolves that record and resumes that exact call. Unproven.
