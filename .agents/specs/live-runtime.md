...
| LIVE-6 | `prv_6_resolves_only_an_override_or_the_user_root`, `prv_6_key_resolution_is_explicit_and_redacted`, `cmd_2_selected_api_key_environment_is_removed_even_without_credential_shape`, `catalog_key_identity_must_match_resolved_model`, `endpoint_resolution_is_protocol_specific_and_rejects_embedded_authority`, `invalid_configuration_never_takes_over_the_terminal`, `executable_private_driver_reenters_a_pinned_directory_and_execs_ripgrep` |
