...
| Invariant | Proven by |
| --- | --- |
| TIM-1 | `tim_1_turn_boundaries_are_durable_and_terminal_time_does_not_advance_the_head`, `tim_1_queued_turn_and_steering_keep_their_original_accepted_time`, `tim_1_every_live_turn_terminal_path_has_a_typed_outcome`, `tim_1_invalid_terminal_records_change_nothing`, `tim_1_partial_head_mutations_preserve_or_refuse_the_open_turn`, `tim_1_unscoped_user_and_lifecycle_payloads_change_nothing`, `runtime_clock_values_reach_durable_turn_boundaries`, `cancelled_submit_behind_an_older_commit_keeps_its_arrival_time_and_text`, `tim_1_turn_chronology_reopens_from_jsonl_without_entering_model_context`, `tim_1_jsonl_rejects_timeless_user_and_unscoped_lifecycle_records`, `tim_1_format_one_is_rejected_before_loading_timeless_records`, `tim_1_long_turn_history_reduces_with_indexed_stability` |
| TIM-2 | Unproven |
| TIM-3 | Unproven |
