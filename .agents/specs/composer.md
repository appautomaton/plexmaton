...
The command filter paints its own caret and leading inset. Its single row scrolls horizontally
...
| Draft longer than the visible lines | The visible window follows the caret |
