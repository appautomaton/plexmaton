...
| Field | Value |
| --- | --- |
| Status | RaTeX selected; source-linked native reply verified; production ownership and interaction gates pending |
...
[MTH-1–MTH-4](../specs/math-layout.md), including standalone full-reply native rendering;
live conversation integration remains pending.
...
- Source reveal and exact copy must be available without shifting surrounding content, including
  ...
  drag expansion/highlighting and mixed Markdown copy remain unproven.
...
The selected reuse boundary and fixed-corpus evidence are in MTH-1–MTH-4. Remaining decisions concern
owned preparation, terminal capability/partial visibility and atomic conversation interaction;
